    ...
    <Dialog fullScreen open={true} onClose={close} className={classes.dialogWrapper}>
      <div className={classes.dialogContainer}>
        <div className={classes.warningContainer}>
          ...
          <Typography className={classes.title1}>Elonswap Disclaimer:</Typography>
          ...
          <Typography className={classes.paragraph} align="center">
            <span>
            Use of the Elonswap website, services, dapp, or application is subject to the following terms and conditions and I hereby confirm that by proceeding and interacting with the protocol I am aware of these and accept them in full:
            </span>
            <br /><br />
            Elonswap is a smart contract protocol in alpha stage of launch, and even though multiple security audits have been completed on the smart contracts, I understand the risks associated with using the Elonswap protocol and associated functions.
            <br /><br />
